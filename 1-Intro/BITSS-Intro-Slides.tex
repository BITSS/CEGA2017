...
{CEGA, November 2017\\
Slides available online at \url{http://www.github.com/BITSS/INSP2017}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Replications --- Guidelines \& Protocols}
...
\section{Research Transparency for Policy}

\begin{frame}{Research Transparency for Policy}
\begin{itemize}
\item Policy-evidence link with \textbf{high} transparency. 
\item Policy-evidence link with  \textbf{low} transparency. 
\item BITSS proposal.
\end{itemize}
\end{frame}

\begin{frame}{One link between evidence and public policy}
...
\begin{frame}[shrink=30,label=lack_cred]{Policy-Evidence Link With Low Transparency \& Reproducibility }
...
\begin{frame}{Our Proposal Reproduciblity and Transparency for Policy}
\begin{enumerate}

\item Publish guidelines on transparency and reproducilbity for policy analysis (similar to the TOP, described before). 

\item Partner with agencies/think tanks interested in implementing this ideas.
...
\begin{itemize}[<.->]
\item Take our MOOC (E. Miguel).\href{https://www.futurelearn.com/courses/open-social-science-research}{\beamergotobutton{Link}}
\item Subscribe to the BITSS blog \& E-mail list \href{https://bitss.org/blog}{\beamergotobutton{Link}}
\item Apply for our RT2 Summer Institute. \href{http://www.bitss.org/events/summer-institute/}{\beamergotobutton{Link}}
\item Become a Catalyst!
...
\item Check out our resource website \href{http://www.bitss.org/resource-tag/education/}{\beamergotobutton{Link}}
\item Interested in incorporating some of this practices into policy analysis? Email me! \href{mailto:fhoces@berkeley.edu}{fhoces@berkeley.edu}
